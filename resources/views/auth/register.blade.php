                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="image64" id="image64" hidden>

                                <img src="https://via.placeholder.com/80"
                                    class="rounded float-right" alt="..." style="width:80px;height:80px" id="avatar">
                            </div>
                        </div>
...
<script>
    function checkIMG(evt){
        ...
        fileReader.onload = function(progressEvent) {
            ...
            document.getElementById('image64').value=imgURL;
        }
    }
</script>
