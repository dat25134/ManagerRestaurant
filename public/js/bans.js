...
function showAll_bans(){
    ...
    $.ajax({
        url : `https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/showBans`,
        method : "get",
        dataType : "json",
...
bans.delAll = function(id){
    ...
    $.ajax({
        url: `https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/delBan/${id}`,
        method: 'delete',
        dataType: 'json',
        success: function(data){
...
bans.show = function(idKV){
    $.ajax({
        url : `https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/bans/${idKV}`,
        method : "get",
        dataType : "json",
        success : function(data){
            $('#myTableBans tbody').empty();
...
bans.create =function(){
     if ($('#reg-form').valid()){
        ...
        $.ajax({
            url:"https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/createBan",
            method: 'POST',
            data:data,
            success : function(){
...
bans.infoModal = function(id){
    ...
    $('#error').empty();
    $.ajax({
        url: `https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/getBan/${id}`,
        method: 'get',
        dataType: 'json',
        success: function(data){
            $('#id').val(data.id);
...
bans.edit = function(){
    ...
    $.ajax({
        url:`https://family-nhahanggiadinh.herokuapp.com/dashboard/ban_an/editBan/${id}`,
        method:'put',
        dataType:'json',
        data: {
            name:name,
