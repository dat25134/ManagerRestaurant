...
ctkms.infoModal = function(id){
    $.ajax({
        url: `http://localhost:8000/dashboard/ctkm/ctkmAPI/${id}`,
        method: 'get',
        dataType: 'json',
        success: function(data){
            $('#id').val(data.id);
...
ctkms.create =function(){
    if ($('#reg-form').valid()){
       ...
       $.ajaxSetup({
        ...
        $.ajax({
           url:"http://localhost:8000/dashboard/ctkm/create",
           method: 'POST',
           data:data,
           success : function(){
            ctkms.closeModal();
...
ctkms.edit = function(){
    ...
    $.ajax({
        url:`http://localhost:8000/dashboard/ctkm/editCTKM/${id}`,
        method:'put',
        dataType:'json',
        data: {
            name:name,
...
ctkms.del = function(id){
    ...
    $.ajax({
        url: `http://localhost:8000/dashboard/ctkm/delCTKM/${id}`,
        method: 'delete',
        dataType: 'json',
        success: function(data){
