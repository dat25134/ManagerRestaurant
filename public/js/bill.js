...
bills.show = function(){
    $.ajax({
        url : 'http://localhost:8000/dashboard/bills/billsAPI',
        method : "get",
        dataType : "json",
...
bills.showDate = function(element){
    day = $(element).val();
    $.ajax({
        url : 'http://localhost:8000/dashboard/bills/getBillDay',
        method : "get",
        dataType : "json",
        data: {day:day},
        success : function(data){
...
bills.chitiet = function(id){
    ...
    $('#chiTietBill').show();
    $.ajax({
        url : `http://localhost:8000/dashboard/bills/getBillsAPI/${id}`,
        method : "get",
        dataType : "json",
        success : function(data){
            $('#myTable tbody').empty();
