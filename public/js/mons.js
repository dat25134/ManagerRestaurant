...
mons.infoModal = function(id){
    $.ajax({
        url: location.origin+`/dashboard/mons/monAPI/${id}`,
        method: 'get',
        dataType: 'json',
        success: function(data){
            $('#id').val(data.id);
...
mons.create =function(){
     if ($('#reg-form').valid()){
        ...
        $.ajaxSetup({
         ...
         $.ajax({
            url:location.origin+"/dashboard/mons/create",
            method: 'POST',
            data:data,
            success : function(){
                mons.closeModal();
...
mons.edit = function(){
    ...
    $.ajax({
        url:location.origin+`/dashboard/mons/editMon/${id}`,
        method:'put',
        dataType:'json',
        data: {
            name:name,
...
mons.del = function(id){
    ...
    $.ajax({
        url: location.origin+`/dashboard/mons/delMon/${id}`,
        method: 'delete',
        dataType: 'json',
        success: function(data){
