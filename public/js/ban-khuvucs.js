...
khuvuc_ban.get = function(){
    $.ajax({
        url: 'http://localhost:8000/dashboard/ban_an/bans',
        method: 'get',
        data: 'json',
...
khuvuc_ban.create =function(){
     if ($('#reg-form').valid()){
        ...
        $.ajax({
            url:"http://localhost:8000/dashboard/ban_an/createKV",
            method: 'POST',
            data:data,
            success : function(){
...
khuvuc_ban.infoModal = function(id){
    ...
    $('#error').empty();
    $.ajax({
        url: `http://localhost:8000/dashboard/ban_an/getKV/${id}`,
        method: 'get',
        dataType: 'json',
        success: function(data){
            $('#id').val(data.id);
...
khuvuc_ban.edit = function(){
    ...
    $.ajax({
        url:`http://localhost:8000/dashboard/ban_an/editKV/${id}`,
        method:'put',
        dataType:'json',
        data: {
            name:name,
...
khuvuc_ban.del = function(id){
    ...
    $.ajax({
        url: `http://localhost:8000/dashboard/ban_an/delKV/${id}`,
        method: 'delete',
        dataType: 'json',
